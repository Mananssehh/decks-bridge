...
**For DJ testing only.** This build is ad-hoc signed, not notarized. Do not publish this DMG on the public Decks website.
...
- `Decks Bridge_0.1.0_aarch64.dmg` (recommended)
- `Decks.Bridge_0.1.0_aarch64.app.zip`
